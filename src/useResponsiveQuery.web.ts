...
const getResponsiveStyles = (
  ...
  const identifierHash = hash(queryString);
    ...
    Object.keys(results).forEach((key) => {
      ...
      if (dataAttribute) {
        ...
        results[key].rules.forEach((oldRule: string) => {
          ...
          // Here by prepending the /*${newIdentifier}{}*/ comment, we're kind of tricking the regex used by rn-web to verify if a rule is inserted or not.
